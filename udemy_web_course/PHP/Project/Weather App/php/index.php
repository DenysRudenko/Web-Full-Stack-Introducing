...
if (isset($_GET['city'])) {
    ...
    $urlContent = file_get_contents('https://api.openweathermap.org/data/2.5/weather?q=' . $_GET['city'] . '&units=metric&appid=f66e7efc9182aef5d0c5b65b52a2e5e6');
    ...
    <div class="container" id="mainDiv">
        ...
        <form>
            <div class="form-group">
                <label for="forCity">Input a city name</label>
                <input class="form-control" name="city" id="city" aria-describedby="For Cast" placeholder="Enter Your City">
            </div>
